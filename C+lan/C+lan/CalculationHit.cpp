...
bool Ctlan::PublicSystem::CalculationHit::SegmentToSegment(Vector3 mySegmentStart, Vector3 mySegmentEnd, Vector3 _otherSegment_Start, Vector3 _otherSegment_End)
{
    // ===== 判定に必要なベクトルを作成 ===== //
    // ** 自身の線分用 ** //
...
bool Ctlan::PublicSystem::CalculationHit::SegmentToQuadrangle(Vector3 mySegmentStart, Vector3 mySegmentEnd, Vector3 _otherRightTop, Vector3 _otherLeftBottom)
{
...
bool Ctlan::PublicSystem::CalculationHit::SegmentToHexahedron(Vector3 mySegmentStart, Vector3 mySegmentEnd, const Transform* otherHexahedron)
{
...
bool Ctlan::PublicSystem::CalculationHit::SegmentToHexahedron(Vector3 mySegmentStart, Vector3 mySegmentEnd, DirectX::BoundingBox otherBoundingBox, const Transform* otherHexahedron)
{
    // 境界ボックスの中心、幅を代入
...
bool Ctlan::PublicSystem::CalculationHit::PointToQuadrangle(Vector3 _myPoint, Vector3 _otherRightTop, Vector3 _otherLeftBottom)
{
