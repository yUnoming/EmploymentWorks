...
namespace Ctlan
{
	...
	{
		class Transform;	// Ctlan::PublicSystem::Transformを使うための前方宣言
	}
}
...
// 　　		 using宣言		 　　 //
// ＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝ //
using namespace Ctlan::PublicSystem;
using namespace Ctlan::PrivateSystem;
	...
	namespace PrivateSystem
	{
		...
		class GameObject
		{
			...
			public:
				...
				/// <summary>
				/// 当たり判定時	</summary>
				virtual void HitCollision(Ctlan::PrivateSystem::GameObject* other)
				{
					// リスト内のコンポーネントを一つずつ取得
