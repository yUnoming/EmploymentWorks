...
// 　　staticメンバ変数の定義　　 //
// ＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝ //
std::vector<HFONT> Ctlan::PrivateSystem::SystemManager::SystemTextRendererManager::m_createFonts;
std::vector<Ctlan::PrivateSystem::SystemManager::SystemTextRendererManager::FontTextureData> Ctlan::PrivateSystem::SystemManager::SystemTextRendererManager::m_fontTextureDatas;
...
ID3D11ShaderResourceView* Ctlan::PrivateSystem::SystemManager::SystemTextRendererManager::GetShaderResourceView(ID3D11Texture2D* fontTexture)
{
	// シェーダーリソースビューの情報を設定
	...
	// シェーダーリソースビューの作成
	HRESULT hr = Ctlan::PrivateSystem::Renderer::GetDevice()->CreateShaderResourceView(fontTexture, &srvDesc, &shaderResourceView);
...
ID3D11Buffer* Ctlan::PrivateSystem::SystemManager::SystemTextRendererManager::GetVertexBuffer(TextRenderer textData, int fontNum)
{
	// 頂点バッファの設定
	VERTEX_3D vertex[4];
	// 左上
...
void Ctlan::PrivateSystem::SystemManager::SystemTextRendererManager::SetFont(HFONT addFont)
{
	// 引数で受け取ったフォントを追加する
...
#include "KeyInput.h"
void Ctlan::PrivateSystem::SystemManager::SystemTextRendererManager::Input(int keyCode)
{
	// 入力可能状態のテキストが存在する？
	EngineObject::SpectatorCamera* specCamera = SystemSceneManager::GetEditScene()->GetSceneObject<EngineObject::SpectatorCamera>("SpectatorCamera");
...
ID3D11Texture2D* Ctlan::PrivateSystem::SystemManager::SystemTextRendererManager::CheckFontTexture(char text)
{
