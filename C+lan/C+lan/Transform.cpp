...
Ctlan::PublicSystem::Transform::Transform(const Transform* other)
{
	// 値代入
...
void Ctlan::PublicSystem::Transform::Draw()
{
	// 親が存在しない？
	if (!parent)
...
DirectX::SimpleMath::Matrix Ctlan::PublicSystem::Transform::GetWorldMatrix(Transform* childTransform)
{
	// 親の行列
...
Transform& Ctlan::PublicSystem::Transform::operator=(const Transform& other)
{
	// 自分自身ではない？
	if (this != &other && this)
	{
