...
class Meteor : public GameObject
{
	...
	public:
		...
		void Init()
		{
			...
			AddComponent<Material>()->materialColor = Color(0.698f, 0.133f, 0.133f, 1.0f);
		...
		void HitCollision(GameObject* other)
		{
			...
			if (otherMeteor)
			{
				...
				if (!isCalcVelocity)
				{
					...
					SceneManager::GetNowScene()->GetSceneObject<ParticlePool>("ParticlePool")->GenerateParticle(generatePos);
				}
			}
		}
};
